...
export function Symbol (props: any) {
  const {r1, r2, s, ...spring} = useSpring({
    reverse: props.$d,
    from: {r1: 10, r2: 20, s: .9, stroke: "#e2e2e2", strokeDashoffset: 67.5},
    to: {r1: 20, r2: 10, s: .8, stroke: "#000", strokeDashoffset: 17.5},
  });
  return (
    <animated.svg viewBox="0 0 100 50" style={{transform: s.to((v=1) => `scale(${v})`)}}>
